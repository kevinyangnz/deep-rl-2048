...
| empty_bonus     | -(game.empty_tiles * 0.1) | game.empty_tiles represents the number of empty tiles in the board at each action. <br>Penalises the agent for having many occupied tiles on the board. |
